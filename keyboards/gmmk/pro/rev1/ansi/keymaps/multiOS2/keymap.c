...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *      ~        1        2        3        4        5        6        7        8        9        0         -       (=)      BackSpc           Insert
     ...
     *
     * ,-------------------------------------------------------------------------------------------------------------.
     * | Esc  ||  F1  |  F2  |  F3  |  F4  ||  F5  |  F6  |  F7  |  F8  ||  F9  | F10  | F11  | F12  | Delete | Mute |
     * |=============================================================================================================|
  ...
  // default mac layout which matches key caps (except for top function row mappings)
    ...
    */
    ...
    [_WIN] = LAYOUT(
        KC_ESC,  KC_BRID, KC_BRIU, KC_F3,      KC_F4,   RGB_VAD, RGB_VAI, KC_F7,   KC_F8,   KC_F9,   KC_MPRV, KC_MPLY,  KC_MNXT,    KC_DEL,           KC_MUTE,
        KC_GRV,  KC_1,    KC_2,    KC_3,       KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,  KC_EQL,     KC_BSPC,          KC_INSERT,
        KC_TAB,  KC_Q,    KC_W,    KC_E,       KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,  KC_RBRC,    KC_BSLS,          KC_PGUP,
        MT_CAPS, KC_A,    KC_S,    KC_D,       KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,              KC_ENT,           KC_PGDN,
        KC_LSFT,          KC_Z,    KC_X,       KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,              KC_RSFT, KC_UP,   KC_END,
...
// Not using the ENCODER_MAP function as the encoder_update_user is taking over to delegate to the rotary_functions
#if defined(ENCODER_MAP_ENABLE)
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_MAC] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [_WIN] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [_FNALL] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [_FNREVERT] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [_FNMENU] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) }
};
#endif
